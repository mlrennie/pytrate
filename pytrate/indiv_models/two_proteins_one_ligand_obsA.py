...
class TPOL_obsA(Model):
    """
    Three-component ternary interaction (A,B,L) assuming component A is monitored ...
    
    Fobs = F_A*[A] + F_AL*[AL] + F_AB*[AB] + F_ABL*[ABL] 
    ...
    def obs_calc(self):
        ...
        # constrain observable parameter
        #self.param_values["F_ABL"] = self.param_values["F_AL"]
        ...
        to_return = (self.param_values["F_A"]*A + self.param_values["F_AL"]*AL + \
                    self.param_values["F_AB"]*AB + self.param_values["F_AL"]*ABL) / At
